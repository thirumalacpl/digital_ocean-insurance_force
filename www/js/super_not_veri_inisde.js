...
//alert(oneemp);
  $('.sddqinot').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oneemp+'"><img src="http://insurance.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oneemp+'"><img src="http://insurance.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://insurance.fourthforce.in/uploads/'+one+'"><img src="http://insurance.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oneo+'"><img src="http://insurance.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oneoo+'"><img src="http://insurance.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oneooo+'"><img src="http://insurance.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://insurance.fourthforce.in/uploads/'+oner+'"><img src="http://insurance.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.ssd').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if ( j == 0){
  ...
  //alert(one+'oneiiiiiiiiiiiiiiiiiiiiiiiiiii');
   $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+one+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
  $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oneo+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 2){
  var oneoo=oneaddress[j];
//alert(oneoo+'3');
//$('.document_imag_inproone_notveria').append('<img src="http://insurance.fourthforce.in/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oneoo+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 3){
  var oneooo=oneaddress[j];
//alert(oneooo+'4');
//$('.document_imag_inproone_notverid').append('<img src="http://insurance.fourthforce.in/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oneooo+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
//$('.document_imag_inproone_notverie').append('<img src="http://insurance.fourthforce.in/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oner+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
//$('.document_imag_inproone_notverif').append('<img src="http://insurance.fourthforce.in/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://insurance.fourthforce.in/documents/addressid/'+oner+'"><img src="http://insurance.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
$.ajax({url: "http://insurance.fourthforce.in/slim_insurance/slim_four_ripsssjs/supervisor_status_to_inprogress.php?status_val="+status_val+"&verification_user_id="+verification_user_id+"&remark="+remark+"&qualification_id="+qualification_id+"&region_num="+region_num,
