...
var imz='<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right" style="background-color:#BC3217;width:50px;height: 50px;">Close</a><img src="http://insurance.fourthforce.in/insurance/super/'+img_id+'" alt="Photo portrait" class="imgzz imguirot">'
$('.imj').append(imz);
});
...
var settings = {
  ...
  url: "http://insurance.fourthforce.in/insurance/uploadas.php",
  method: "POST",
